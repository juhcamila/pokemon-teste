...
class TreinadorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create treinador" do
    assert_difference('Treinador.count') do
      post treinadors_url, params: { treinador: { idade: @treinador.idade, nome: @treinador.nome, sexo: @treinador.sexo } }
    end
  ...
  test "should update treinador" do
    patch treinador_url(@treinador), params: { treinador: { idade: @treinador.idade, nome: @treinador.nome, sexo: @treinador.sexo } }
